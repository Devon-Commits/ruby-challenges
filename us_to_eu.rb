...
# You and your friends are going to Europe! You have made plans to travel around Europe
# with your friends, but one thing you need to take into account so that everything goes
# according to play, is that the format of their date is different than from what is used
# in the United States. Your job is to convert all your dates from MM/DD/YYYY to DD/MM/YYYY.

# Task: 
# Create a function that takes in a string containing a date that is in US format, and
# return a string of the same date converted to EU.
